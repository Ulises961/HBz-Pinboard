                ...
                <div class="row gutters-sm">
                  <div class="col-sm-6 mb-3">
                    <div class="card h-100">
                      <div class="card-body">
                        <h6 class="d-flex align-items-center mb-3"><i class="material-icons text-info mr-2">Add your Announcement</i></h6>
                        <div class="wrap-input100 validate-input">
                          <input class="input100" type="Insert title" name="Insert title" id="Insert title" placeholder="Insert title">
                          <span class="focus-input100"></span>
                          <span class="symbol-input100">
                            <i class="fa fa-envelope" aria-hidden="true"></i>
                          </span>
                        </div>
                        <input class="input100" type="Add description" name="Add description" id="Add description" placeholder="Add description">
                          <span class="focus-input100"></span>
                          <span class="symbol-input100">
                            <i class="fa fa-envelope" aria-hidden="true"></i>
                          </span>
                        ...
                        <button class="btn btn-primary">Add link Image</button>
