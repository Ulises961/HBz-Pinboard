...
echo "                   class='mr-3 rounded-circle' width='50' alt='User' /></a>";
echo "           <div class='media-body'>";
echo "               <h6><a href='Question.php?id=$id' data-toggle='collapse' data-target='.forum-content'";
echo "                       class='text-body'>$title</a></h6>";
echo "               <p class='text-secondary'> $content</p>";
echo "               <p class='text-muted'><a href='javascript:void(0)'>jlrdw</a> replied <span";
echo "                       class='text-secondary font-weight-bold'>3 hours ago</span></p>";
echo "           </div>";
echo "           <div class='text-muted small text-center align-self-center'>";
echo "               <span class='d-none d-sm-inline-block'><i class='far fa-eye'></i> 18</span>";
echo "               <span><i class='far fa-comment ml-2'></i> 1</span>";
echo "           </div>";
echo "           </div>";
echo "       </div>";
echo "   </div>";
